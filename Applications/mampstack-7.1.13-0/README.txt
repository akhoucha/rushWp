...
bitnami-mampstack-7.1.13-0-osx-x86-installer.dmg 
...
a regular user, or /opt/mampstack-7.1.13-0, if you are running the 
...
/Applications/mampstack-7.1.13-0 and that you use port 8080 for Apache and 3306 for MySQL.
