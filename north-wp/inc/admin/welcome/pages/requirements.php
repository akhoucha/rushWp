...
<table class="widefat" cellspacing="0">
	<thead>
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			...
			<tr>
				<td data-export-label="PHP Version"><?php esc_html_e( 'PHP Version:', 'north' ); ?></td>
				<td>
					<?php 
					...
					?>
						...
						<?php else: ?>
							<mark class="<?php echo esc_attr($mark); ?>">
									...
									<?php esc_html_e('Required PHP Version is at least 5.6. WordPress <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using at least PHP 7.0.</a> ', 'north'); ?>
							</mark>
						<?php endif; ?>
					<?php	} ?>
				</td>
			...
			<tr>
				<td data-export-label="PHP Time Limit"><?php esc_html_e( 'PHP Time Limit', 'north' ); ?>:</td>
				<td>
					<?php
		...
		<?php endif; ?>
		<tr>
			<td data-export-label="Max Upload Size"><?php esc_html_e( 'Max Upload Size', 'north' ); ?>:</td>
			<td>
				<?php
