...
function thb_ocdi_after_import( $selected_import ) {
  ...
  flush_rewrite_rules();
	...
	set_theme_mod( 'nav_menu_locations' , array('mobile-menu' => $navigation->term_id, 'nav-menu' => $navigation->term_id, 'acc-menu-in' => $logged_in->term_id, 'acc-menu-out' => $logged_out->term_id, 'footer-menu' => $footer->term_id ) );
}
