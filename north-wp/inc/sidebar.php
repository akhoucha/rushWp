...
function thb_register_sidebars() {
	register_sidebar(array('name' => 'Shop Sidebar', 'id' => 'thb-shop-filters', 'description' => 'The sidebar visible in the shop page, used for filters', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
