<?php function thb_button( $atts, $content = null ) {
  ...
  extract( $atts );
	...
	ob_start();
	?>
	<a class="<?php echo implode(' ', $class); ?>" href="<?php echo esc_attr($link_to); ?>" target="<?php echo sanitize_text_field( $a_target ); ?>" role="button" title="<?php echo esc_attr( $a_title ); ?>"><?php echo esc_attr($a_title); ?></a>
